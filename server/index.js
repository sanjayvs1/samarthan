...
Ensure that each step's code is executable in isolation, and the final code can be constructed by combining all the steps. Include class definitions, method declarations, and return statements.

For example, for the question "How to implement a method to add two numbers in Java?":
{
  "question": "How to implement a method to add two numbers in Java?",
  "id": "unique-id-123",
  "steps": [
    {
      "step_id": 1,
      ...
      "desired_output": "",
      "hint": "Start by defining the class.",
      "keywords": [
        {"keyword": "class", "description": "Used to declare a class in Java."}
      ]
    },
    {
      "step_id": 2,
      ...
      "desired_output": "",
      "hint": "Define the method with parameters for the numbers.",
      "keywords": [
        {"keyword": "public", "description": "Access modifier for the method."},
        {"keyword": "static", "description": "Indicates that the method belongs to the class, not instances of the class."},
    ...
    {
      "step_id": 4,
      "step_title": "Add the main method",
      "code": "  public static void main(String[] args) {\n    System.out.println(addTwoNumbers(5, 3));\n  }\n}",
      "desired_output": "Prints the sum of the numbers.",
      "hint": "Complete the class with a main method to test the addTwoNumbers method.",
      "keywords": [
        {"keyword": "main", "description": "The entry point of a Java program."}
      ]
    }
  ],
  "language": "Java"
...
Ensure that each step's code is executable in isolation, and the final code can be constructed by combining all the steps. Include function definitions and return statements.
  ...
  "steps": [
    {
      ...
      "hint": "Start by defining the function with parameters for the numbers.",
      "keywords": [
        {"keyword": "def", "description": "Used to define a function in Python."}
      ]
    },
    {
      "step_id": 2,
